      ...
      <section className="text-gray-600 body-font flex flex-col">
        <div className="container w-full flex flex-wrap">
          <div className="flex relative pt-10 pb-20 sm:items-center md:w-2/3 mr-auto">
            ...
            <div className="flex-grow md:pl-8 pl-6 flex sm:items-center items-start flex-col sm:flex-row">
              ...
              <div className="flex-grow sm:pl-6 mt-6 sm:mt-0">
                ...
                <p className="leading-relaxed text-gray-600 dark:text-gray-400">V.V.P Engineering college,Rajkot</p>
                <p className="leading-relaxed text-gray-600 dark:text-gray-400">Jan 2022 - Present</p>
              </div>
            </div>
          </div>
          <div className="flex relative pb-20 sm:items-center md:w-2/3 mr-auto">
            ...
            <div className="flex-grow md:pl-8 pl-6 flex sm:items-center items-start flex-col sm:flex-row">
              <div className="flex-shrink-0 w-24 h-24 bg-white text-indigo-500 rounded-full inline-flex items-center justify-center">
                <img src="https://images.shiksha.com/mediadata/images/1589346152phpKJZJ6Z.jpeg" className="p-5" />
              </div>
              <div className="flex-grow sm:pl-6 mt-6 sm:mt-0">
                <h2 className="font-medium title-font text-gray-900 dark:text-gray-300 mb-1 text-xl">
                  Diploma in Engineering •2018
                </h2>
                <p className="leading-relaxed text-gray-600 dark:text-gray-400">Government polytechnic porbandar</p>
                <p className="leading-relaxed text-gray-600 dark:text-gray-400">Oce 2021 - Dec 2021</p>
              </div>
            </div>
          </div>
        </div>
