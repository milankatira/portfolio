...
export default function Header({}: Props) {
  return (
    <header className="sticky shadow-md overflow-hidden bg-white dark:bg-black top-0 px-5 flex items-start xl:items-center justify-between w-full mx-auto z-20">
      <motion.div
        initial={{
          x: -500,
          opacity: 0,
